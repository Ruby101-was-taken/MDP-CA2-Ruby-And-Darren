...
BoxColliderBehaviour::BoxColliderBehaviour(sf::Vector2f size_, CollisionLayer layer_, CollisionLayer mask_, bool is_trigger_)
    : BaseColliderBehaviour(layer, mask, is_trigger)
    , size_(size_)
{
}
